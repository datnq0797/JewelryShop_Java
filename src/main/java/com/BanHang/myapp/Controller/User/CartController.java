...
import com.BanHang.myapp.Service.user.BillsServiceImpl;
import com.BanHang.myapp.Service.user.CartServiceImpl;
...
public class CartController extends BaseController{
	...
	public ModelAndView home() {
		...
		_mvShare.addObject("products", _homeService.GetDataNew_Products());	
		return _mvShare; 
