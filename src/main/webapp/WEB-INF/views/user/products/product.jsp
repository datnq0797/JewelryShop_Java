			...
			<ul class="nav nav-list promowrapper">
				<li>
					<div class="thumbnail">
						<a class="zoomTool" href="product_details.html"
							...
							VIEW</a> <img src="<c:url value="/assets/user/img/bootstrap-ecommerce-templates.PNG"/>" alt="bootstrap ecommerce templates">
						<div class="caption">
							<h4>
				...
				<li>
					<div class="thumbnail">
						<a class="zoomTool" href="product_details.html"
							title="add to cart"><span class="icon-search"></span> QUICK
							VIEW</a> <img src="<c:url value="/assets/user/img/shopping-cart-template.PNG"/>" alt="shopping cart template"/>
			...
			<div class="well well-small">
				...
				<div id="myTabContent" class="tab-content tabWrapper">
					...
					<div class="tab-pane fade" id="profile">
						...
						<c:if test="${productByIdCate.size() > 10}">
							<c:set var="countList" value="6" />
						</c:if>

						<c:forEach var="item" begin="1" end="${ countList }" items="${productByIdCate }"
							varStatus="loop">
