		...
		<div class="topNav">
			<div class="container">
				<div class="alignR">
					...
					<a class="active" href="<c:url value="/trang-chu"/>"> <span class="icon-home"></span> Home
					</a>
...
-->
	...
	<button onclick="topFunction()" class="gotop" id="myBtn" title="Go to top"><i class="icon-double-angle-up"></i></button>
